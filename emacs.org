...
#+begin_src emacs-lisp
  (use-package smartparens
    ...
    :bind
    ("C-c C-p C-u" . sp-up-sexp)
    ("C-c C-p C-d" . sp-down-sexp)
    ("C-c C-p C-b" . sp-backward-sexp)
    ("C-c C-p C-f" . sp-forward-sexp)
    ("C-c C-p C-a" . sp-beginning-of-sexp)
    ("C-c C-p C-e" . sp-end-of-sexp)
    ("C-c C-p C-p" . sp-previous-sexp)
    :config
